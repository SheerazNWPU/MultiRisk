...
def select_rules_based_on_threshold(rules, rule_threshold):
    """
    ...
    for rule in rules:
        ...
        if rule.infer_class == "0_N" and rule.impurity > rule_threshold[0]:
            continue
        elif rule.infer_class == "1_PB" and rule.impurity > rule_threshold[1]:
            continue
        elif rule.infer_class == "2_UDH" and rule.impurity > rule_threshold[2]:
            continue
        elif rule.infer_class == "3_FEA" and rule.impurity > rule_threshold[3]:
            continue
        elif rule.infer_class == "4_ADH" and rule.impurity > rule_threshold[5]:
            continue
        elif rule.infer_class == "5_DCIS" and rule.impurity > rule_threshold[5]:
            continue
        elif rule.infer_class == "6_IC" and rule.impurity > rule_threshold[6]:
            continue
        else:
