...
if __name__ == "__main__":
    ...
    for data_dir in data_dirs:
        ...
        shutil.rmtree('/home/ssd0/SG/cnn/RiskModelDrop/ER_tree_2_rules/input_data_2020/DBLP-Scholar')
        shutil.copytree('/home/ssd0/SG/sheeraz/result_archive/risk_elem/{}/DBLP-Scholar'.format(data_dir),
                        '/home/ssd0/SG/cnn/RiskModelDrop/ER_tree_2_rules/input_data_2020/DBLP-Scholar')

        generate_rules()

        #  copy decision_tree_rules_clean.txt to risk dataset
        shutil.copy(
            "/home/ssd0/SG/cnn/RiskModelDrop/ER_tree_2_rules/input_data_2020/DBLP-Scholar/325/decision_tree_rules_clean.txt",
